...
df_contribution.write.mode("overwrite").parquet("s3://tf_parquet_bucket/CI_CD(CSV+TO+PARQUET)/contribution/")
df_committee.write.mode("overwrite").parquet("s3://tf_parquet_bucket/CI_CD(CSV+TO+PARQUET)/committee/")
df_candidate.write.mode("overwrite").parquet("s3://tf_parquet_bucket/CI_CD(CSV+TO+PARQUET)/candidate/")
