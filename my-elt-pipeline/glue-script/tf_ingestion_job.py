...
df_contribution.write.mode("overwrite").parquet("s3://tf-parquet-bucket-pc/CI_CD(CSV+TO+PARQUET)/contribution/")
df_committee.write.mode("overwrite").parquet("s3://tf-parquet-bucket-pc/CI_CD(CSV+TO+PARQUET)/committee/")
df_candidate.write.mode("overwrite").parquet("s3://tf-parquet-bucket-pc/CI_CD(CSV+TO+PARQUET)/candidate/")
