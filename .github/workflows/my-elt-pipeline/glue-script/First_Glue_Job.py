...
target_files = [
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00000-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet",
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00001-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet",
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00002-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet",
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00003-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet",
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00004-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet",
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00005-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet",
   "s3://poliscan.master.dataset/Master_DataSet(.parquet)/part-00006-bb10d3c8-2779-419d-ab09-7f2965b25305-c000.snappy.parquet"
]
df_all = spark.read.parquet(*target_files)
...
dot_count = df_clean.filter(col("committee_party_affiliation") == ".").count()
print(f"Total records with '.' as party affiliation: {dot_count}")
...
df_final.coalesce(1).write \
    .mode("overwrite") \
    .parquet("s3://glued.bucket/Final_Glued_Folder/")
